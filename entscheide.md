...
| Datum | Entscheid | Wo ausführlich |
| --- | --- | --- |
| 06.09.2026 | Probewebsites: Mattia übergibt den Firmenprompt von Hand an Claude Code, keine automatische KI-Anbindung | `agency-automation-os/CLAUDE.md` §9 |
| 08.09.2026 | Zielgebiet Root LU, 15 km; HLKS zuerst, dann Gastro und lokale KMU | `agency-automation-os/CLAUDE.md` §2 |
| 23.09.2026 | Kein nutzbares Netzwerk; Website/SEO/Inbound statt Netzwerkgespräche | Vault `20_Projekte/signedbymattia — Website, SEO und Anfragen.md` |
| 24.09.2026 | Akquise über Google-Suche und LinkedIn organisch; CHF 60 pro Anfrage als Ziel | Vault `40_Entscheide/Akquise ueber Google-Ads und LinkedIn.md` |
...
| 24.09.2026 | Google-Test-Vorschlag CHF 150 statt 600 (nicht freigegeben) | `agency-automation-os/projects/lead-engine/config/budgets.yaml` |
...
| 24.09.2026 | Website Core: CHF 1'600 testen (vorher 1'200) | `grundlagen/angebote-preise.md`, `agency-automation-os/projects/lead-engine/config/offers.yaml` |
...
| 24.09.2026 | Anmeldung: Einzelunternehmen im Nebenerwerb ohne HR-Eintrag, AHV-Anerkennung beantragen, keine GmbH (Richtung, noch nicht umgesetzt) | `recht/pflichtangaben.md` |
| 24.09.2026 | ⭐ Prio 1 ist die Marken-Identität (Farben, Typo, Logo, Dokumentvorlagen), vor Website und Anmeldung | `marke/DESIGN.md` |
| 24.09.2026 | Identität „Edition“: Barock-Collage (Tiepolo-Himmel + Web-Dinge), Pastell-Farben mit Pastell-Pink, Host Grotesk + Instrument Serif, Logo „signed *by* mattia“, Taglines „Kein Template. Ein Werk.“ / „Gemalt in Code.“, Wow in zwei Akten (Himmelsflug, 3D-Galerie), Echtheitszertifikat; löst die drei Markenrichtungen ab | `marke/DESIGN.md`, `marke/entwuerfe/identitaet-edition-v2.html` |
