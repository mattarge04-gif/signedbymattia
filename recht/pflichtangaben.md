...
Diese Punkte blockieren Website-Livegang, Google-Anzeigen und die
LinkedIn-Unternehmensseite:

| Punkt | Status | Blockiert |
| --- | --- | --- |
| Rechtsform und Handelsregistereintrag | **noch nichts angemeldet** (24.09.2026) [F]; Richtung: Einzelunternehmen im Nebenerwerb, ohne HR-Eintrag, keine GmbH [A, siehe unten]; **Prio 1** | Impressum, LinkedIn-Seite, Offerten |
...
nicht umgesetzt; im Vault als Pendenz **⭐ Prio 1**, Frist 18.10.2026.
...
- **MWST Schweiz: 8,1 %** seit 1.1.2024.
- **AHV-Freigrenze Nebenerwerb: CHF 2'500** pro Jahr (seit 2025).

## Annahmen, vor Gebrauch prüfen [A]

- MWST-Pflicht erst ab CHF 100'000 Jahresumsatz; darunter Preise ohne MWST
  ausweisen.
- Websites mit Angeboten brauchen klare Angaben zur Identität und Kontaktadresse
  (UWG).
- Die Datenschutzerklärung (revDSG) muss Besucherstatistik (Umami oder GA4),
  Google-Tag/Ads, eingebundene Dienste und das Kontaktformular nennen.
- LinkedIn-Unternehmensseiten und die Community Management API setzen eine
  echte Organisation voraus.

## Regeln, die schon gelten [F]

- Kein Kontakt ohne legitime Quelle, echte Absenderidentität, einfachen
  Widerspruch; Opt-out sperrt sofort (Agency-Masterplan, Vault „KI-Gesetze fuer
  die Agency“).
- Keine erfundenen Aussagen, Bewertungen oder Resultate.
- Bild- und Textrechte vor jeder Veröffentlichung prüfen.
